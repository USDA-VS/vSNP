...
class Get_Specie_Parameters():
    ...
    def choose(self, species_selection):
        ...
        def get_tb_codes():
            if os.path.isfile("/genotyping_codes.xlsx"):
                tb_geno_codes = ("/genotyping_codes.xlsx")
            elif os.path.isfile("/genotyping_codes.xlsx"):
                tb_geno_codes = ("/genotyping_codes.xlsx")
            else:
                return None
        ...
        def get_para_codes():
            if os.path.isfile("/avium_genotyping_codes.xlsx"):
                tb_geno_codes = ("/avium_genotyping_codes.xlsx")
            elif os.path.isfile("/avium_genotyping_codes.xlsx"):
                tb_geno_codes = ("/avium_genotyping_codes.xlsx")
        ...
        def get_brucella_codes():
            if os.path.isfile("/ALL_WGS.xlsx"):
                bruc_geno_codes = ("/ALL_WGS.xlsx")
            elif os.path.isfile("/ALL_WGS.xlsx"):
                bruc_geno_codes = ("/ALL_WGS.xlsx")
            else:
                return None
        ...
        if species_selection == "ab1":
            ...
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/abortus1/script1",
                "spoligo_db": None,
                ...
                "step2_upload": str(self.upload_to) + "/brucella/abortus1/script2",
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/abortus3/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/abortus3/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/canis/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/canis/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/ceti1/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/ceti1/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/ceti2/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/ceti2/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/melitensis-bv1/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/melitensis-bv1/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/melitensis-bv1b/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/melitensis-bv1b/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/melitensis-bv2/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/melitensis-bv2/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/melitensis-bv3/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/melitensis-bv3/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/suis1/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/suis1/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/suis2/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/suis2/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/suis3/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/suis3/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/suis4/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/suis4/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/ovis/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/ovis/script2",
                "script_dependents": script_dependents,
            }
            ...
            genotype_codes = get_brucella_codes()
            parameters = {
                "upload_to": str(self.upload_to) + "/brucella/neotomae/script1",
                "spoligo_db": None,
                ...
                "remove_from_analysis": script_dependents + "/RemoveFromAnalysis.xlsx",
                "filter_file": script_dependents + "/Filtered_Regions.xlsx",
                "step2_upload": str(self.upload_to) + "/brucella/neotomae/script2",
                "script_dependents": script_dependents,
            }
