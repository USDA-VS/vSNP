...
from vsnp_change_names import Change_Names
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(prog='PROG', formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        ...
        fasta_snps.py -f *fasta
        ---------------------------------------------------------


    '''), epilog='''---------------------------------------------------------''')

    parser.add_argument('-f', '--fasta', action='store', dest='fasta', default=None, required=False, help='provide an aligned fasta')
    ...
    snp_alignment = Get_Snps(working_directory=working_directory)
